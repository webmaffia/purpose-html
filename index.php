		...
		<section class="section-hope">
			<div class="section-hope__content">
				<img src="assets/images/New folder/half-circle.svg" alt="" class="section-hope__half-circle"
					aria-hidden="true" />
				<p class="section-hope__tagline">We catalyze treatments that</p>
			...
			<div class="section-framework__circles">
				<div class="section-framework__circle">
					<span class="section-framework__circle-inner">
						...
						<span class="section-framework__circle-desc">The principles that guide our decisions and
							actions.</span>
					</span>
				</div>
				<div class="section-framework__circle">
					<span class="section-framework__circle-inner">
						...
						<span class="section-framework__circle-desc">How we plan to achieve our vision and deliver
							impact.</span>
					</span>
				</div>
				<div class="section-framework__circle">
