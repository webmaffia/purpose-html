...
<body>
    ...
    <main>
        <!-- Hero section -->
        <section class="leadership__hero">
            <img class="leadership__hero-image" src="assets/images/hero/Mask group (2).png" alt="Hero section image"
                fetchpriority="high" />
        </section>

        <!-- Title -->
        <div class="leadership__container">
            <h1 class="leadership__title">OUR LEADERSHIP</h1>
            ...
            <section class="leadership__employees-image-section">
                <div class="leadership__employees-image-container">
                    ...
                    <div class="leadership__employee-card" data-name="RAMESH SWAMINATHAN"
                        data-role="Executive Director, Global CFO, Head of IT and API plus SBU"
                        data-quote="At Lupin, financial stewardship goes beyond numbers - it’s about catalyzing impact. We invest with purpose, aligning capital with strategies that empower patients, energize teams, and uplift communities."
                        data-image="assets/images/leadership/Ramesh Swaminathan.png">
                        <img fetchpriority="high" class="leadership__employee-image leadership__hidden"
                            src="assets/images/leadership/Ramesh Swaminathan.png" alt="Employee image 2" />
                        <div class="leadership__employee-info">
                            <h4>Ramesh Swaminathan</h4>
                            <p>Executive Director, Global CFO, Head of IT and API plus SBU</p>
                        </div>
                    </div>
                    ...
                    <div class="leadership__employee-card" data-name="RANJANA PATHAK" data-role="Chief Quality Officer"
                        ...
                        <img fetchpriority="high" class="leadership__employee-image leadership__hidden"
                            src="assets/images/leadership/Dr Ranjana Pathak.png" alt="Employee image 3" />
                        <div class="leadership__employee-info">
                    ...
                    <div class="leadership__employee-card" data-name="SOFIA MUMTAZ"
                        data-role="President, Legal and Compliance, Canada, ANZ, and NEA business"
                        data-quote="We’re building a future-ready organization grounded in ethics and driven by excellence. Every partnership and every product is an opportunity to deliver care that catalyzes healing."
                        data-image="assets/images/leadership/Sofia Mumtaz1 (2).png">
                        <img fetchpriority="high" class="leadership__employee-image leadership__hidden"
                            src="assets/images/leadership/Sofia Mumtaz1 (2).png" alt="Employee image 4" />
                        <div class="leadership__employee-info">
                            <h4>Sofia Mumtaz</h4>
                    ...
                    <div class="leadership__employee-card" data-name="SPIRO GAVARIS"
                        ...
                        data-image="assets/images/leadership/Spiro Gavaris.png">
                        <img fetchpriority="high" class="leadership__employee-image leadership__hidden"
                            src="assets/images/leadership/Spiro Gavaris.png" alt="Employee image 4" />
                        <div class="leadership__employee-info">
                            <h4>Spiro Gavaris</h4>
    ...
    <!-- Card pop-up -->
    <div class="leadership__modal" id="leadershipModal">
        <div class="leadership__modal-content">

            <!-- Close Button -->
            <img src="assets/images/leadership/shapes/Group 400.png" class="leadership__modal-close" id="modalClose"
                alt="Close" />

            <!-- Left Image -->
            <div class="leadership__modal-left">
                <div class="leadership__image-wrapper">
                    <img id="modalImage" src="assets/images/leadership/Yashwant Mahadik_1.png" alt="Employee">
                </div>
            </div>

            <!-- Right Content -->
            <div class="leadership__modal-right">

                <img src="assets/images/leadership/shapes/Vector (1).png" class="quote quote-top" alt="quote" />

                <div class="modal-body">
                    <p id="modalText">
                        Quote text will come here dynamically.
                    </p>
                </div>
                ...
                <img src="assets/images/leadership/shapes/Vector (2).png" class="quote quote-bottom" alt="quote" />
...
<!-- Cards display when clicked on view button -->
<script>
    const btn = document.getElementById("viewAllBtn");
    const container = document.querySelector(".leadership__employees-image-container");
...
<script>
    const cards = document.querySelectorAll(".leadership__employee-card");
    ...
    const modalLeft = document.querySelector(".leadership__modal-left");
    ...
    cards.forEach((card, index) => {
        card.addEventListener("click", () => {
            ...
            modalText.textContent = card.dataset.quote;
            modalName.textContent = card.dataset.name;
            modalRole.textContent = card.dataset.role;

            // Remove previous background classes
            modalLeft.classList.remove("green-bg", "grey-bg");

            // Toggle based on card position 
            if ((index + 1) % 2 === 0) {
                modalLeft.classList.add("grey-bg");
            } else {
                modalLeft.classList.add("green-bg");
            }
